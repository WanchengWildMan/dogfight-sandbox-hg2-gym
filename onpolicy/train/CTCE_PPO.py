...
def get_args():
    ...
    parser.add_argument("--PERIODS_PER_EPISODE", type=int, default=8, help="alpha fixed in")
    ...
    parser.add_argument("--experiment_name", type=str, default=f"{num_users},{num_UAVs},{num_BSs},CTCE,UAV_ALLOC_b,POSITION_SAMPLING,seed_diff", help="an identifier to distinguish different experiment.")
