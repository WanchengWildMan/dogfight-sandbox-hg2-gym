...
def parse_args(args, parser):
    ...
    parser.add_argument("--POSITION_SAMPLE_STEPS", type=int, default=None, help="alpha fixed in")
    parser.add_argument("--PERIODS_PER_EPISODE", type=int, default=1, help="alpha fixed in")
    ...
    parser.add_argument("--experiment_name", type=str, default=f"{num_users},{num_UAVs},{num_BSs},{WIDTH}m,W_server=0.001,ppo_epoch=2,load_known", help="an identifier to distinguish different experiment.")
