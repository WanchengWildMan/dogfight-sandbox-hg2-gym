...
from onpolicy.envs.env_acc_mind_associate import AssociateACCEnv
...
def make_train_env(all_args):
    def get_env_fn(i):  # 返回能获取环境的函数
        def init_env(i):
            env = AssociateACCEnv(i, all_args)
...
def parse_args(args, parser):
    parser.add_argument('--scenario_name', type=str, default='energy_acc_associate', help="Which scenario to run on")
    ...
    parser.add_argument("--a_servers_max", type=float, default=5, help="maximum velocity of UAVs")
    ...
    parser.add_argument("--FIX_alpha_STEP", type=int, default=25, help="alpha fixed in")
    parser.add_argument("--EXP_REW", type=bool, default=False, help="alpha fixed in")
    parser.add_argument("--MAX_R", type=bool, default=True, help="alpha fixed in")
    parser.add_argument("--POSITION_SAMPLE_STEPS", type=int, default=40000, help="alpha fixed in")
    parser.add_argument("--PERIODS_PER_EPISODE", type=int, default=4, help="alpha fixed in")
    ...
    parser.add_argument("--experiment_name", type=str, default=f"MAPPO_acclerate_{num_users},{num_UAVs},{num_BSs},{WIDTH}m,FIX_alpha_STEP=25", help="an identifier to distinguish different experiment.")
