...
from onpolicy.envs.MPE_simple_my import MPESimpleEnv
...
def parse_args(args, parser):
    ...
    parser.add_argument('--num_UAVs', type=int, default=2, help="number of UAVs and BS!@!")
    parser.add_argument("--num_BSs", type=int, default=0, help="number of BSs in UAVs")
    parser.add_argument("--ground_length", type=float, default=100, help="ground length")
    parser.add_argument("--ground_width", type=float, default=100, help="ground width")
    ...
    parser.add_argument("--env_name", type=str, default='MPEEnv', help="specify the name of environment")
