...
from onpolicy.envs.env_relay import MainRelayEnv
...
def parse_args(args, parser):
    parser.add_argument('--scenario_name', type=str, default='DemoRelay', help="Which scenario to run on")
    ...
    parser.add_argument("--POSITION_SAMPLE_STEPS", type=int, default=10000, help="alpha fixed in")

    parser.add_argument("--DEMO", type=bool, default=True, help="DEMO")
    parser.add_argument("--env_name", type=str, default='MyRelay', help="specify the name of environment")
    parser.add_argument("--experiment_name", type=str, default="POSITION_SAMPLE_STEPS10000_TLE_not-use-valuenormdiff_out-0.4_sigma1e-9_gamma0.8_lr1e-4", help="an identifier to distinguish different experiment.")
