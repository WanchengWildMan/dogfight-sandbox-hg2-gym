...
class SharedReplayBuffer(object):
    ...
    def __init__(self, args, num_agents, obs_space, cent_obs_space, act_space, long_decision_agent=False):
        self.episode_length = args.episode_length
        self.n_rollout_threads = args.n_rollout_threads
        self.hidden_size = args.hidden_size
        self.recurrent_N = args.recurrent_N
        if long_decision_agent:
            self.gamma = args.gamma_long
        else:
    ...
    def feed_forward_generator_slow(self, advantages, num_mini_batch=None, mini_batch_size=None):
        """
    ...
    def feed_forward_generator(self, advantages, num_mini_batch=None, mini_batch_size=None):
        ...
        yield share_obs, obs, rnn_states, rnn_states_critic, actions, \
